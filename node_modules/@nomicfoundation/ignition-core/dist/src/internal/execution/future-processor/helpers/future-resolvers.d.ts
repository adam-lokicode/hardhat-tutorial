...
import { AccountRuntimeValue, AddressResolvableFuture, ArgumentType, ContractFuture, Future, ModuleParameterRuntimeValue, ReadEventArgumentFuture, SolidityParameterType, StaticCallFuture } from "../../../../types/module";
 ...
 */
export declare function resolveValue(givenValue: bigint | ModuleParameterRuntimeValue<bigint> | StaticCallFuture<string, string> | ReadEventArgumentFuture, deploymentParameters: DeploymentParameters, deploymentState: DeploymentState): bigint;
/**
 ...
 */
export declare function resolveAddressLike(addressLike: string | AddressResolvableFuture | ModuleParameterRuntimeValue<string>, deploymentState: DeploymentState, deploymentParameters: DeploymentParameters): string;
/**
