...
async function buildInitializeMessageFor(future, deploymentState, strategy, deploymentParameters, deploymentLoader, accounts, defaultSender) {
    switch (future.type) {
        ...
        case module_1.FutureType.CONTRACT_DEPLOYMENT:
            const deploymentExecStateInit = _extendBaseInitWith(messages_1.JournalMessageType.DEPLOYMENT_EXECUTION_STATE_INITIALIZE, future, strategy, {
                ...
                value: (0, future_resolvers_1.resolveValue)(future.value, deploymentParameters, deploymentState),
        ...
        case module_1.FutureType.LIBRARY_DEPLOYMENT:
            const libraryDeploymentInit = _extendBaseInitWith(messages_1.JournalMessageType.DEPLOYMENT_EXECUTION_STATE_INITIALIZE, future, strategy, {
                futureType: future.type,
                artifactId: future.id,
                contractName: future.contractName,
                constructorArgs: [],
        ...
        case module_1.FutureType.CONTRACT_CALL: {
            const namedContractCallInit = _extendBaseInitWith(messages_1.JournalMessageType.CALL_EXECUTION_STATE_INITIALIZE, future, strategy, {
        ...
        case module_1.FutureType.STATIC_CALL: {
            const namedStaticCallInit = _extendBaseInitWith(messages_1.JournalMessageType.STATIC_CALL_EXECUTION_STATE_INITIALIZE, future, strategy, {
                args: (0, future_resolvers_1.resolveArgs)(future.args, deploymentState, deploymentParameters, accounts),
        ...
        case module_1.FutureType.CONTRACT_AT: {
            const contractAtInit = _extendBaseInitWith(messages_1.JournalMessageType.CONTRACT_AT_EXECUTION_STATE_INITIALIZE, future, strategy, {
                futureType: future.type,
                contractName: future.contractName,
                contractAddress: (0, future_resolvers_1.resolveAddressLike)(future.address, deploymentState, deploymentParameters),
                artifactId: future.id,
            });
        ...
        case module_1.FutureType.READ_EVENT_ARGUMENT: {
            ...
            const readEventArgInit = _extendBaseInitWith(messages_1.JournalMessageType.READ_EVENT_ARGUMENT_EXECUTION_STATE_INITIALIZE, future, strategy, {
        ...
        case module_1.FutureType.SEND_DATA:
            const sendDataInit = _extendBaseInitWith(messages_1.JournalMessageType.SEND_DATA_EXECUTION_STATE_INITIALIZE, future, strategy, {
...
function _extendBaseInitWith(messageType, future, strategy, extension) {
    return {
        type: messageType,
        futureId: future.id,
