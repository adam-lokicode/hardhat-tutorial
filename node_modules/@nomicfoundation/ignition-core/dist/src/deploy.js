...
const basic_execution_strategy_1 = require("./internal/execution/basic-execution-strategy");
...
async function deploy({ config = {}, artifactResolver, provider, executionEventListener, deploymentDir, ignitionModule, deploymentParameters, accounts, defaultSender: givenDefaultSender, }) {
    ...
    const executionStrategy = new basic_execution_strategy_1.BasicExecutionStrategy((artifactId) => deploymentLoader.loadArtifact(artifactId));
