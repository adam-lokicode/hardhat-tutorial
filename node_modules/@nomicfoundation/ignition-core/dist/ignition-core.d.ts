 ...
 * @beta
 */
export declare function getVerificationInformation(deploymentDir: string, customChains?: ChainConfig[]): AsyncGenerator<VerifyResult>;
 ...
 * @beta
 */
export declare type ModuleParameterType = SolidityParameterType;
 ...
 * @beta
 */
declare function status_2(deploymentDir: string): Promise<StatusResult>;
